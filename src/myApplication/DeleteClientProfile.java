 ...
 * @author Kriss
 */
public class DeleteClientProfile extends javax.swing.JInternalFrame {

    /**
     * Creates new form ViewClientProfile1
     */
    public DeleteClientProfile() {
        super("Delete Client Profile");
        initComponents();
        bluser = new BLUser();
        user = new User();
        ...
        try{
            ...
            jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
                public void valueChanged(ListSelectionEvent event) {
                    ...
                    int option = JOptionPane.showConfirmDialog(rootPane, "Client username as: " + jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString() + " is going to be deleted.", null, 2);
                    if (option == JOptionPane.OK_OPTION) {
                        try {
                            BLUser bluser = new BLUser();
                            /*That particular client is deleted*/
                            bluser.deleteClientProfile(num_id);
    ...
    public void refreshTable() {
        ...
        try{
            ...
            bluser.setUser(this.user);
            ResultSet rs = bluser.selectClientProfile();
            while(rs.next()) {
                Object ObjData[] = new Object[12];
                ObjData[0] = rs.getInt("userId");
                ObjData[1] = rs.getString("username");
